...
export const Card = forwardRef<HTMLDivElement, CardProps>(({ customClass, className, ...rest }, ref) => (
  <div
    ...
    {...rest}
    className={cn(
      "absolute top-1/2 left-1/2 rounded-none border border-white/12 bg-[#070a14] shadow-[0_30px_60px_-20px_rgba(0,0,0,0.85)] overflow-hidden [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden]",
      customClass,
      className
    )}
  />
